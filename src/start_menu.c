...
static EWRAM_DATA u8 sStartMenuSpritesId[9]= {};  //definicion de starmenuspriteid max 9 botones
...
//**********************************************
//ICONS MENU CORTESIA: CACO5400        
//**********************************************

#define TAG_ICONS_MENU 0x3333

#define INITIAL_POS_RIGHT_X 0           //no se usa pero lo dejo por aqui xd
#define INITIAL_POS_RIGHT_Y 140         //posicion inicial eta pabajito pero no al ultimo pixel que es 160 lol xd
...
static const struct OamData gSpriteOamData32 =      //HOENNWALKER POR SUS TUTOS EN ENTENDIMIENTO Y A SAMU TMBN POR SU TEMPLATE
{
    .y = 0,
    .affineMode = 0,
    .objMode = 0, 
...
static const struct SpriteSheet spriteSheetIconsMenu =
{
            ...
            .size = 4096, //TAMAÃ‘O DEL GRÃFICO
...
void LoadSpriteIconMenu()
{
    ...
    if(sNumStartMenuActions ==4) x=70;  // para centrarlo segun cuantos flags iconos activados
    if(sNumStartMenuActions ==5) x=60;
    if(sNumStartMenuActions ==6) x=48;
    if(sNumStartMenuActions ==7) x=32;
